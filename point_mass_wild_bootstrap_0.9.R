...
output<-foreach(i = 1:M,.combine = append,.options.RNG=793, .packages = c("quantreg","sn")) %dorng% wild_bootstrap(i)
stopCluster(cl)
...
write.csv(SD, file="0.9_point_mass_SE.csv")
